                    ...
                    <table class="table">
                      <thead>
                          <tr>
                              ...
                              <th class="addfont" style="width: 300px">Số Sản Phẩm Đã Mua</th>
                      ...
                      foreach (selectAll("SELECT * FROM taikhoan WHERE id = '$idtaikhoan1'") as $rows) {
                        $sosp = rowCount("SELECT soluong FROM ctdonhang WHERE id_donhang = $id_donhang1");
                      ?>
                          <tr class="addfont">
                              <td>
                                <?= $stt++ ?></td>
                              ...
                              <td>
                                <?php 
                              foreach (selectAll("SELECT * FROM donhang WHERE status=3 && id_taikhoan = $idtaikhoan1 &&
                                id = $id_donhang1") as $item) {
                              ?>
