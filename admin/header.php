...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="assets/images/logo-trang-chu.jpg">
    <!-- plugins:css -->
    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-logo" href="index.php"><img src="assets/images/logo-trang-chu.jpg" alt="logo" /></a>
          <a class="sidebar-brand brand-logo-mini" href="index.php"><img src="assets/images/logo-trang-chu.jpg" alt="logo" /></a>
        </div>
        <ul class="nav ">
