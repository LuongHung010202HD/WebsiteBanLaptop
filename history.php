  ...
  <section class="cart_area padding_top1">
                            ...
                            <tr class="bottom_button">
                                ...
                                <td>
                                    <?php
                                        if ($status == 1) {
                                    ?>
                                    <button class="genric-btn primary circle" name="cancel" href="history.php" onclick = "return confirm('Bạn có muốn hủy đơn hàng này không?')" >Hủy</button>
                                    <?php 
                                        }
                                    ?>
                                </td>
    ...
    <?php
        if (isset($_POST['cancel'])) {
            selectAll("UPDATE donhang SET status = 4 WHERE id=$idDh");
            echo "<script>
