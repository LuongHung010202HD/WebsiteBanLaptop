...
<head>
  ...
  <title>Banhang</title>
  <link rel="icon" href="img/logo-trang-chu.jpg">
  <!-- Bootstrap CSS -->
            ...
            <form class="cart_inner" method="post" action="">
                <div class="table-responsive">
                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input class="input-number" type="number" name="soluong[<?= $item['id_sanpham'] ?>]" value="<?= $item['soluong'] ?>" min="1" max="100"/>
                                    </div>
                                </td>
                                <td>
                                ...
                                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                    foreach ($_POST['soluong'] as $idSP => $value) {
                                        selectAll("UPDATE ctdonhang SET soluong = $value WHERE id_donhang = $idDh && id_sanpham = $idSP");
                                    }
                            ...
                            <tr class="bottom_button">  
                                <td>
                                    <input class="btn_1" type='submit' value='Cập nhật giỏ hàng' style="border: none">
                                </td>
                                <td></td>
                                <td>
                                    <h5>Tổng cộng: </h5>
                    ...
                    <div class="checkout_btn_inner float-right">
                        ...
                        <a class="btn_1" href="?dathang">Đặt Hàng</a>
                    </div>
